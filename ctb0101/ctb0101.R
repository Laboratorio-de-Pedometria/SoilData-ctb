...
ctb0101_event[, cobertura := NA_character_] 
cobertura_cols <- c("cobertura")
concat_columns(ctb0101_event, target = "cobertura", sources = cobertura_cols)

#vegetacao
ctb0101_event[, vegetacao := NA_character_]
ctb0101_event[, .N, by = vegetacao]

# erosao
ctb0101_event[, erosao := NA_character_]
erosao_cols <- c("erosao")
concat_columns(ctb0101_event, target = "erosao", sources = erosao_cols)
ctb0101_event[, .N, by = erosao]
