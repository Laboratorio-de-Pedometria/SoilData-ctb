...
ctb0049_event[!is.na(data_ano), ano_fonte := "original"]
ctb0049_event[, .N, by = ano_fonte]
...
ctb0049_event[, pedregosidade := NA_character_]

# Rochosidade (superficie)

ctb0049_event[, rochosidade := NA_character_]
...
# citation
ctb0049 <- merge(ctb0049, ctb0049_citation, by = "dataset_id", all.x = TRUE)
